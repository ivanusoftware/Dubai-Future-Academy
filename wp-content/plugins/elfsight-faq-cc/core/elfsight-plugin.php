...
if (!class_exists('ElfsightFaqPlugin')) {
    class ElfsightFaqPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightFaqPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightFaqWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightFaqPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightFaqWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightFaqVCElement($config, $this->widgetsApi);
